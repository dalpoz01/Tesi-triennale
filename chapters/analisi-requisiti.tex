...
\section{Tracciamento dei requisiti}
    ...
    \subsection{Requisiti funzionali}
        ...
        \begin{table}[H]%
            ...
            \hline
            RFO2    & Il sistema deve permettere l'integrazione con servizi e applicazioni che espongono dati tramite \emph{\gls{apig}} in formato \emph{\gls{JSONg}} & Obbligatorio\\
            \hline
            ...
            \hline
            RFO4    & Il sistema deve consentire l'esportazione dei report in molteplici formati (\emph{\gls{pdfg}\glsfirstoccur}, DOC, XLSX) & Obbligatorio\\
            \hline
            ...
            \hline
            RFO6    & Il sistema deve garantire supporto a database \emph{\gls{sqlg}\glsfirstoccur} e \emph{NoSQL} & Obbligatorio\\
            \hline
    ...
    \subsection{Requisiti non funzionali}
        ...
        \begin{table}[H]%
            ...
            \hline
            RNFO3    & Il sistema deve consentire una facile integrazione con applicazioni esistenti sviluppate in \emph{\gls{Javag}}, \emph{.NET} e \emph{\gls{pythong}} & Obbligatorio\\
            \hline
    ...
    \subsection{Riepilogo dei requisiti}
        Nella tabella \ref{tab:riepilogo-requisiti} è riportato un riepilogo dei requisiti individuati, suddivisi per tipologia e classificazione. Questo consente di avere una panoramica chiara e sintetica dell'insieme dei requisiti che guideranno lo sviluppo del progetto.
        \begin{table}[H]
            \centering
