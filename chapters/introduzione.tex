...
\begin{description}
    ...
    \item[{\hyperref[cap:valutazione]{Il sesto capitolo}}] descrive le prestazioni ottenute durante i test effettuati sul prototipo di reportistica sviluppato rispetto a JasperServer.
